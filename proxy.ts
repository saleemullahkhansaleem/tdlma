...
/**
 * Proxy (formerly middleware) for authentication and route protection
 * 
 * In Next.js 16, the middleware.ts file convention has been replaced with proxy.ts
 * and the function export name changed from "middleware" to "proxy".
 */
